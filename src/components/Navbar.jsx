    ...
    <header className="fixed top-0 left-0 w-full z-50">
      ...
      <div className="hidden md:flex justify-between items-center w-full bg-green-800 text-white text-sm py-2 px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-1">
          <a
            href="tel:+918490054441"
            className="flex items-center gap-2 hover:text-green-200 transition cursor-pointer"
          >
            <span>📞</span> +91 84900 54441
          </a>

          <a
            href="tel:+918401894441"
            className="flex items-center gap-2 hover:text-green-200 transition cursor-pointer"
          >
        ...
        <div className="flex flex-col gap-1 items-end">
          <a
            href="mailto:sales@scentorgo.com"
            className="flex items-center gap-2 hover:text-green-200 transition cursor-pointer"
          >
          ...
          <a
            href="mailto:info@scentorgo.com"
            className="flex items-center gap-2 hover:text-green-200 transition cursor-pointer"
          >
